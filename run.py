...
def get_stock_values(data):
    """
    Build a dictionary, where the keys are the sandwich 
    headings pulled from the spreadsheet, and the values
    are the calculated stock data.
    """
    print("Make the following numbers of sandwiches for next market:\n")
    headings = SHEET.worksheet("stock").get_all_values()
    headings = headings[0]
    
    dictionary = dict(zip(headings, stock_data))
    return dictionary
